...
import com.nhatbh.basedefensev2.boss.impl.generic.passive.titansmantle.TitansMantleController;
import com.nhatbh.basedefensev2.boss.impl.generic.passive.titansmantle.TitansMantleEventHandler;
                    ...
                    if (ctx.boss().level() instanceof ServerLevel level) {
                        ...
                        for (Vec3 targetPos : targets) {
                            ...
                            for (Player p : hitPlayers) {
                                ...
                                p.hurtMarked = true;
                                p.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 200, 1, false, true));
                            }
