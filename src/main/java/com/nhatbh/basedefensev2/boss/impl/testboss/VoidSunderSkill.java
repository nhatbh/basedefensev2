    ...
    public static ActiveSequence create() {
        return ActiveSequence.builder("void_sunder")
                ...
                .onTick(ctx -> {
                    ...
                    BossSkillHelper.performDynamicSweep(ctx, dir, -90.0, 90.0, 7.0, 6.0f, 12.0f, 10, true,
                ...
                .onTick(ctx -> {
                    ...
                    BossSkillHelper.performDynamicSweep(ctx, dir, 90.0, -270.0, 6.0, 6.0f, 12.0f, 15, true,
                            ParticleTypes.SWEEP_ATTACK);
                })
                    ...
                    if (ctx.getTicks() % 2 == 0) {
                        ...
                        if (dir != null && ctx.boss().level() instanceof ServerLevel level) {
                            ...
                            level.getEntitiesOfClass(LivingEntity.class,
                                    new net.minecraft.world.phys.AABB(pos.subtract(2, 1, 2), pos.add(2, 3, 2)))
                                    .forEach(e -> {
                                        if (e != ctx.boss()) {
